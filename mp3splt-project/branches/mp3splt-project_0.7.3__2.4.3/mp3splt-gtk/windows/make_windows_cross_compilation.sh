...
for a in lib/*.la;do
  sed -i 's/\/usr\/lib\/libgstreamer-0.10.la/-lgstreamer-0.10/g' $a || exit 1
  sed -i 's/\/usr\/lib\/libintl.la/-lintl/g' $a || exit 1
  sed -i 's/\/lib\/libiconv.la/-liconv/g' $a || exit 1
  sed -i 's/\/usr\/lib\/libxml2.la/-lxml2/g' $a || exit 1
done

for a in lib/gstreamer-0.10/*.la;do
  sed -i 's/\/usr\/lib\/libgstreamer-0.10.la/-lgstreamer-0.10/g' $a || exit 1
  sed -i 's/\/usr\/lib\/libintl.la/-lintl/g' $a || exit 1
  sed -i 's/\/lib\/libiconv.la/-liconv/g' $a || exit 1
  sed -i 's/\/usr\/lib\/libxml2.la/-lxml2/g' $a || exit 1
