...
{
  mp3splt_set_progress_function(ui->mp3splt_state, lmanager_change_window_progress_bar);
  mp3splt_set_split_filename_function(ui->mp3splt_state, lmanager_put_split_filename);
  mp3splt_set_message_function(ui->mp3splt_state, lmanager_put_message_from_library);
