...
cd ../trunk/mp3splt-gtk/windows/installer

#we put the correct installer path
cp win32_cross_installer.nsi win32_cross_installer.nsi_old
cat win32_cross_installer.nsi | sed s+.define\ MP3SPLT_PATH.*+\!define\ MP3SPLT_PATH\ `pwd`/../../..+ > win32_cross_installer.nsi2
mv win32_cross_installer.nsi2 win32_cross_installer.nsi
...
mv win32_cross_installer.nsi_old win32_cross_installer.nsi
