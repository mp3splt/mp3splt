...
LIBMP3SPLT_REAL_VERSION="0.8.2"
MP3SPLT_REAL_VERSION="2.5.2"
MP3SPLT_GTK_REAL_VERSION="0.8.2"

BUILD_SOURCE_PACKAGES=0

RUN_UNIT_TESTS=0
RUN_FUNCTIONAL_TESTS=0
BUILD_BINARY_PACKAGES=1

BUILD_UBUNTU_PACKAGES=0
#$BUILD_BINARY_PACKAGES
BUILD_DEBIAN_PACKAGES=0
#$BUILD_BINARY_PACKAGES
